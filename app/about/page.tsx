...
const ECOSYSTEM = [
  { name: 'RulesForge', desc: 'AI coding rules generator', href: 'https://rulesforge.vercel.app', active: true },
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="mb-16">
          <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors mb-8 inline-block">&larr; Back to RulesForge</Link>
          <h1 className="text-4xl font-bold text-white mb-4">About RulesForge</h1>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.2 }} className="mb-16">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
            <p className="text-zinc-300 leading-relaxed mb-4">
              AI Business Factory builds developer tools powered by AI. We believe the best software is built when developers have the right guardrails, templates, and automation at their fingertips.
            </p>
            <p className="text-zinc-300 leading-relaxed">
              RulesForge helps teams establish consistent AI coding standards across any project. Whether you use Claude, Cursor, or any AI assistant, our curated rules ensure your AI writes code that matches your team&apos;s conventions.
            </p>
          </div>
        </motion.section>
            ...
            {ECOSYSTEM.map((product) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {product.active && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400">You are here</span>
                  )}
                </div>
